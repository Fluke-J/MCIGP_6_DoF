...
class CornellDataset(GraspDatasetBase):
    ...
    def _get_crop_attrs(self, idx):
        ...
        # Compute mean center directly from rectangle points to avoid relying
        # on dynamic attribute dispatch.
        points = [gr.points for gr in gtbbs.grs]
        center = np.mean(np.vstack(points), axis=0).astype(int)
